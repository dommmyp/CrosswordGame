  ...
  return (
    <div className="interface">
      ...
      <div className="scores">
        ...
        <div style={{ fontSize: "30px", fontWeight: "bold", display: activeCrosswordInfo.scores[1]!=0 ? 'block' : 'none' }}>
          Player 2:
          <div style={{ color: "rgb(40, 109, 139)" }}>{activeCrosswordInfo.scores[1]}</div>
        </div>
        <div style={{ fontSize: "30px", fontWeight: "bold", display: activeCrosswordInfo.scores[2]!=0 ? 'block' : 'none' }}>
          Player 3:
          <div style={{ color: "rgb(40, 109, 139)" }}>{activeCrosswordInfo.scores[2]}</div>
        </div>
        <div style={{ fontSize: "30px", fontWeight: "bold", display: activeCrosswordInfo.scores[3]!=0 ? 'block' : 'none' }}>
          Player 4:
